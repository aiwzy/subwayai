...
class CNNLSTMModel(nn.Module):
    ...
    def forward(self, x):
        ...
        batch_size, channels, height, width = cnn_feat.shape
        lstm_input = cnn_feat.view(channels, height*width, batch_size)
        lstm_input = lstm_input.permute(1, 2, 0).contiguous()
